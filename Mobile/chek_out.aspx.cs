        ...
        protected void btnPlaceOrder_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    cmd = new SqlCommand(
                        "INSERT INTO CheckoutAddress (FullName, Phone, Address, State, City, Pincode, PaymentMethod, AdvanceAmount, OrderTotal, OrderDate) VALUES ('" +
                        ...
                        payMethod + "', '" +
                        (payMethod == "CashOnDelivery" ? Math.Round(amount * 0.25M, 2) : 0) + "', '" +
                        amount + "', '" +
