...
<p>Total Items in Cart: <asp:Label ID="lblCartItems" runat="server"></asp:Label></p>
<p>Total Cart Amount: <asp:Label ID="lblCartAmount" runat="server"></asp:Label></p>

<p>Total Orders: <asp:Label ID="lblTotalOrders" runat="server"></asp:Label></p>
<p>Total Order Amount: <asp:Label ID="lblTotalOrderAmount" runat="server"></asp:Label></p>
