<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="shop.aspx.cs" Inherits="Mobile.shop" %>
        ...
        <div id="form1" runat="server">
            <div style="margin: 20px;">
                ...
                <div class="mobile-container">
                    <asp:Repeater ID="rptMobiles" runat="server" OnItemCommand="rptMobiles_ItemCommand">
                        <ItemTemplate>
                     ...
                     <h4><%# Eval("Brand") %> - <%# Eval("ModelName") %></h4>
                                <p><b>Price:</b> ₹<%# Eval("Price") %></p>
                                <p><b>RAM:</b> <%# Eval("RAM") %> | <b>Storage:</b> <%# Eval("Storage") %></p>
                                <p><b>Color:</b> <%# Eval("Color") %> | <b>Battery:</b> <%# Eval("BatteryCapacity") %></p>
                                <p><b>Camera:</b> <%# Eval("CameraDetails") %> | <b>OS:</b> <%# Eval("OS") %></p>
                                <small><%# Eval("LaunchDate", "{0:dd-MM-yyyy}") %></small>
                                <p style="font-size: 12px; color: #666;"><%# Eval("Description") %></p>
                                <div>
