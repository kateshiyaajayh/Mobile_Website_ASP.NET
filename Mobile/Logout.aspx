<%@ Page Title="" Language="C#" MasterPageFile="~/Adminpenal.Master" AutoEventWireup="true" CodeBehind="Logout.aspx.cs" Inherits="Mobile.Logout" %>
...
<asp:Content ID="Content7" runat="server" contentplaceholderid="ContentPlaceHolder2">
        ...
        <div class="logout-box">
            ...
            <a href="AdminLogin.aspx" class="btn-login">🔑 Login Again</a>
        </div>
    </div>
            <style>
